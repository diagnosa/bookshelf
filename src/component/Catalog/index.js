...
const url = `${process.env.REACT_APP_GR_URL}/review/list/${process.env.REACT_APP_GR_UID}.xml`;
function Catalog() { 
        ...
        <div>
            {items.map((item) => (
                <Card
                    ...
                    image={item.book[0].image_url[0] || 'https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1467556925l/30835803._SX98_.jpg'}
                />
            ))}
        </div>
    );
